# Generated by Django 6.0 on 2025-12-13 20:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_img', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, verbose_name='image')),
                ('price', models.DecimalField(decimal_places=2, max_digits=10)),
                ('description', models.TextField(blank=True, default='', null=True)),
                ('posted_on', models.DateTimeField(auto_now_add=True, null=True)),
                ('sale', models.BooleanField(default=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categorize', to='product.category')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
